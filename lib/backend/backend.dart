...
import 'schema/itemselecionado_record.dart';
...
export 'schema/itemselecionado_record.dart';
...
/// Functions to query ItemselecionadoRecords (as a Stream and as a Future).
Future<int> queryItemselecionadoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<ItemselecionadoRecord>> queryItemselecionadoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ItemselecionadoRecord.collection,
      ItemselecionadoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ItemselecionadoRecord>> queryItemselecionadoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ItemselecionadoRecord>> queryItemselecionadoRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
